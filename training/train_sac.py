"""Train a SAC policy on the project double-cartpole environment."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--log-dir", type=Path, default=Path("results/logs/sac"))
    parser.add_argument("--model-dir", type=Path, default=Path("results/models/sac"))
    parser.add_argument("--save-name", type=str, default="sac_double_cartpole")
    parser.add_argument("--eval-freq", type=int, default=10_000)
    parser.add_argument("--eval-episodes", type=int, default=5)
    parser.add_argument("--checkpoint-freq", type=int, default=50_000)
    parser.add_argument("--resume", type=Path, default=None, help="path to an existing SAC zip")
